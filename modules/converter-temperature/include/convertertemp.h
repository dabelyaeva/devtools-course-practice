...
#ifndef MODULES_CONVERTER_TEMPERATURE_INCLUDE_CONVERTERTEMP_H_
#define MODULES_CONVERTER_TEMPERATURE_INCLUDE_CONVERTERTEMP_H_
...
class ConverterTemp {
 public:
    ...
    void installMeasureWithoutChangVal(const Measure);
...
#endif  // MODULES_CONVERTER_TEMPERATURE_INCLUDE_CONVERTERTEMP_H_
