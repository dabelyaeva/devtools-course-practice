...
TEST(CurrencyPairTest, Can_Create_Currency_Pair) {
    ...
    // Act
    CurrencyPair currency_pair(currency_code, bid_price, ask_price);
...
TEST(CurrencyPairTest, Can_Set_And_Get_Currency_Price) {
    // Arrange
...
TEST(CurrencyPairTest, Cannot_Set_Incorrect_Bid_Price) {
    // Arrange
    CurrencyPair currency_pair("EUR/USD", 1.1234, 1.2345);
...
TEST(CurrencyPairTest, DISABLED_Spread_History_Is_Saved) {
    // Arrange
    CurrencyPair currency_pair("USD/EUR", 0.8005, 0.8015);
